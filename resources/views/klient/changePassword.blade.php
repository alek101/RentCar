          ...
          <div class="card-body">
            <form method="POST" action="/changePassword">
              ...
              <div class="form-group row">
                <label for="password" class="col-md-4 col-form-label text-md-right">Trenutna lozinka</label>
              ...
              <div class="form-group row">
                <label for="password" class="col-md-4 col-form-label text-md-right">Potvrdi novu lozinku</label>
