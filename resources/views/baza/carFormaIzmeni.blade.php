...
<form class="formZakazivanje" method="POST" action="/baza/car/change">
    <div class="flexColumn">
        ...
        <div class="flexRow">
            <label for="Broj_sasije">Broj sasije<input type="text" name="Broj_sasije" id="Broj_sasije" value={!! $car->Broj_sasije !!}></label>
            <label for="Broj_saobracajne_dozvole">Broj saobracajne dozvole<input type="text" name="Broj_saobracajne_dozvole" 
                id="Broj_saobracajne_dozvole" value={!! $car->Broj_saobracajne_dozvole !!}></label>
            <label for="Broj_registarskih_tablica">Broj Tablica<input type="text" name="Broj_registarskih_tablica" 
                id="Broj_registarskih_tablica" value={!! $car->Broj_registarskih_tablica !!}></label>
        </div>
        <div class="flexRow">
            <label for="Godina_proizvodnje">Godina proizvodnje<input type="number" name="Godina_proizvodnje" 
                id="Godina_proizvodnje" value={!! $car->Godina_proizvodnje !!}></label>
            <label for="Datum_vazenja_registracije">Vazenje registracije<input type="date" name="Datum_vazenja_registracije" 
                id="Datum_vazenja_registracije" value={!! $car->Datum_vazenja_registracije !!}></label>
            <label for="Predjena_km">Predjena kilometraza [km]<input type="number" name="Predjena_km" id="Predjena_km" value={!! $car->Predjena_km !!}></label>
        </div>
        <div class="flexRow">
            <label for="Radjen_mali_servis_km">Mali servis [km]<input type="number" name="Radjen_mali_servis_km" 
                id="Radjen_mali_servis_km" value={!! $car->Radjen_mali_servis_km !!}></label>
            <label for="Radjen_veliki_servis_km">Veliki servis [km]<input type="number" name="Radjen_veliki_servis_km" 
                id="Radjen_veliki_servis_km" value={!! $car->Radjen_veliki_servis_km !!}></label>
        </div>
        <div class="flexRow">
            <label for="Servis">
                Servis
