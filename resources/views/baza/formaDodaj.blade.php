...
<form class="formZakazivanje" method="POST" action="/baza/posalji1">
    <div class="flexColumn">
        ...
        <div class="flexRow">
            <label for="Broj_sedista">Broj Sedista<input type="number" name="Broj_sedista" id="Broj_sedista"></label>
            <label for="Broj_vrata">Broj Vrata<input type="number" name="Broj_vrata" id="Broj_vrata"></label>
            <label for="Broj_torbi">Broj Torbi<input type="number" name="Broj_torbi" id="Broj_torbi"></label>
        </div>
        <div class="flexRow">
