...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2019 at 07:49 PM
...
('153534', '343fsx3', '1Pezo', 'PEUGEOT 308 1.6 HDI', 2015, 84050, '2020-04-02', 82000, 0, 1, 0),
('223212', '22A323', '1Citroen', 'CITROEN C3 1.4 HDI', 2018, 66000, '2019-12-18', 55000, 55000, 1, 0),
('22346494', '422ASD', '2Citroen', 'CITROEN C3 1.4 HDI', 2017, 107500, '2020-01-03', 100000, 100000, 1, 0),
('4R422G5312', '21211113', '1Pezo208', 'PEUGEOT 208 1.4 HDI', 2017, 45000, '2020-02-21', 45000, 45000, 1, 0),
('6321f23', '523232', '1Seat', 'SEAT IBIZA 1.2 TDI', 2019, 10520, '2019-12-04', 10520, 10520, 1, 0),
('ER4235Tr1', '123213213', '2Pezo208', 'PEUGEOT 208 1.4 HDI', 2017, 200000, '2020-03-12', 191000, 100000, 1, 0),
('sasija123', '234354233432', '1OpelAstra', 'OPEL ASTRA KARAVAN', 2019, 90000, '2020-02-14', 75000, 0, 1, 0),
('test101', '12213313341', 'ford1C', 'FORD C MAX 2.0 TDCI', 2019, 0, '2020-11-26', 0, 0, 1, 0),
...
(26, 'RENAULT SCENIC X MOD', 3, '33.00'),
(27, 'RENAULT SCENIC X MOD', 7, '26.00'),
(28, 'RENAULT SCENIC X MOD', 12700, '26.00'),
(29, 'RENAULT CLIO KARAVAN', 3, '30.00'),
(30, 'RENAULT CLIO KARAVAN', 7, '28.00'),
(31, 'RENAULT CLIO KARAVAN', 12700, '26.00');
...
('RENAULT CLIO KARAVAN', 'srednja', 'manuelni', 5, 4, 6, '/images/renault-clio-karavan.jpg', 'nema tt'),
('RENAULT SCENIC X MOD', 'srednja', 'manuelni', 5, 4, 5, '/images/renault-scenic-x-mod.jpg', 'nema'),
('SEAT IBIZA 1.2 TDI', 'mala', 'manuelni', 4, 4, 3, '/images/seat-ibiza-1-2-tdi.jpg', 'nema'),
...
(35, '22346494', 'Aleksandar', 'Alekp111@gmail.com', '4666', '2019-11-19', '2019-11-22', '75.00', 1, 'fefewf'),
...
(43, '6321f23', 'Aleksandar', 'Alekp111@gmail.com', '111', '2019-11-27', '2019-11-28', '32.00', 1, 'test'),
...
(106, '6321f23', 'ADMIN', 'ADMIN', 'ADMIN', '2019-11-17', '2019-11-18', '0.00', 1, 'SERVIS'),
(109, 'ER4235Tr1', 'Alek', 'Alekp111@Gmail.com', '64123456', '2019-11-22', '2019-11-24', '58.00', 1, 'test resource'),
(121, '2563', 'ADMIN', 'ADMIN', 'ADMIN', '2019-11-21', '2019-11-22', '0.00', 1, 'SERVIS'),
(147, '223212', 'Alek', 'Alekp111@Gmail.com', '9964123456', '2019-11-30', '2019-12-02', '50.00', 1, 'no comment'),
(148, '153534', 'Alek', 'Alekp111@Gmail.com', '64123456', '2019-11-30', '2019-12-07', '210.00', 1, 'Kupac nema posebnih zahteva.'),
(149, '4R422G5312', 'Alek', 'Alekp111@Gmail.com', '64123456', '2019-11-30', '2019-12-02', '58.00', 1, 'Kupac nema posebnih zahteva.'),
(152, '153534', 'Jole', 'Jole@Gmail.com', '9965123456', '2019-12-18', '2019-12-22', '120.00', 1, 'Sediste za decu.'),
(153, '22346494', 'Icko', 'Icko@Gmail.com', '992232123232', '2019-12-25', '2019-12-31', '120.00', 1, 'Dodatno osiguranje.'),
(154, 'ER4235Tr1', 'Neregistrovani1', 'Nergistrovani@Gmail.com', '123456787', '2019-12-04', '2019-12-07', '87.00', 1, 'Kupac nema posebnih zahteva.'),
(155, '22346494', 'Her Novi', 'novi@Gmail.com', '4546651182', '2019-12-18', '2019-12-21', '75.00', 1, 'Molim vas za sediste za decu.');
...
(10, '6321f23', '2019-11-16', 10500, 'mali', 'Promenjeno je ulje motora. Promenjen je fillter ulja motora.'),
(11, '6321f23', '2019-11-16', 10520, 'mali', 'Promenjeno je ulje motora.  Promenjen je fillter ulja motora.  Promenjen je filter goriva.  Promenjen je filter vazduha.  Promenjen je filter kabine. Dodatno nesto!'),
(12, '223212', '2019-11-18', 55000, 'mali', 'nesto!  Promenjen je filter vazduha. nesto dodaj Promenjen je filter goriva.  Promenjen je fillter ulja motora.  Promenjeno je ulje motora.  Promenjen je filter kabine. I dr...'),
(13, '6321f23', '2019-11-20', 10520, 'mali', 'Promenjeno je ulje motora.  Promenjen je fillter ulja motora.  Promenjen je filter goriva.  Promenjen je filter vazduha.  Promenjen je filter kabine.'),
(14, '6321f23', '2019-11-20', 10520, 'mali', 'Promenjeno je ulje motora.  Promenjen je fillter ulja motora.  Promenjen je filter goriva.  Promenjen je filter vazduha.  Promenjen je filter kabine.');
...
(1, 'Alek', 'Alekp111@Gmail.com', 100, 64123456, NULL, '$2y$10$NUVD8ZP3Pugog2a2n8NREeO20RmWxu0Yjw5bJnR/YroCava6vXmy.', 'X8t8tgQDLe6PNa5troxzBYynqCvlDYVokFcVcpTnAPu5cahODnGLx2wyqL3q', '2019-11-07 15:26:10', '2019-11-16 14:17:33'),
...
(5, 'novi', 'nova@Gmail.com', 0, 111111445, NULL, '$2y$10$pF5d/xudFmhdZGDmSVpWAuW1g9Isab16xQW.RS99/fGTUiRb.2oi2', NULL, '2019-11-16 14:18:20', '2019-11-16 14:18:31'),
(6, 'Her Novi', 'novi@Gmail.com', 0, 4546651182, NULL, '$2y$10$nXQn.R7vqsD6ykL3lo88Ter..T1POQeEtKLkMg7JYuuMzE2rw1lx2', NULL, '2019-12-01 14:08:36', '2019-12-01 14:08:36');
...
ALTER TABLE `automobili`
  ...
  ADD UNIQUE KEY `Broj_registarskih_tablica` (`Broj_registarskih_tablica`),
...
--
ALTER TABLE `rezervacija`
  MODIFY `ID_rezervacije` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
